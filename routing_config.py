...
max_pack_time_s = 2.0  # 建议考虑节点的运行速率
...
receive_speed = 0.2
receive_buffer = 30
''' 内存容量告警阀值：即已使用容量大于总容量的alarm_buf_rate倍时，会触发相应的机制 '''
alarm_buf_rate = 0.2
